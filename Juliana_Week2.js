...
exercise4(null,undefined);
"null and undefined differ"

exercise4('Juliana','juliana');
"Juliana and juliana differ"
...
// EXERCISE 8.
// Use a switch conditional statement with case clauses such that if `num9` is
// a number and it has a value of 1 that `answer9` is assigned the string:
// "You won!"
// if num9 is 9, then answer9 should be:
// "You are lucky!"
// if num9 is 101, then answer9 should be:
// "Welcome to coding 101!"
// if num9 is 1000000, then answer9 should be:
// "You are one in a million!"
// Othewise, assign answer9 a value of:
// "Thanks for that!"
...
// EXERCISE 9.
// In this exercise, if `item` is a number, follow the rules given in Exercise 9
// except that `answer9` is replaced by `answer9`
...
function exercise9(item) {
    ...
    // Also possible using if (!isNaN(item))
...
// It was easy! I used browser console and MDN website to check answers.
